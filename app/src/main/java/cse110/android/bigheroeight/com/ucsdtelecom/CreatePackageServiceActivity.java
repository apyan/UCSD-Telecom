...
public class CreatePackageServiceActivity extends Activity {
    ...
    public void loadInAppProducts()
    {
        ...
        for( FourTuple product : products)
        {
    ...
    * products so customers can view it*/
    public void onClickCreatePackage(View view)
    {
        ...
        * any other then a package being added*/
        ...
        if(!cancel)
        {
            ...
            boolean success = data.addPackage(productId, typeOfProduct, price);
            if(success)
            {
