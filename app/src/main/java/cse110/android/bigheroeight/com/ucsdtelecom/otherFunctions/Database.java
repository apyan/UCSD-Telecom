...
import bolts.Task;
import cse110.android.bigheroeight.com.ucsdtelecom.FourTuple;
import cse110.android.bigheroeight.com.ucsdtelecom.R;
...
public class Database {
   ...
   * return true else return false*/
    ...
    public boolean checkFee(final String title, String username) {

        ParseQuery<ParseObject> canc = ParseQuery.getQuery("CanceledSubscriptions");
        canc.whereEqualTo("username", username);

        try {
            List<ParseObject> products = canc.find();

            for (ParseObject product : products) {
                String productId = (String) product.get("Title");
                if (productId.equals(title)) {
                    return true;
                }
    ...
    public List<FourTuple> getProductIds() {
        List<FourTuple> ids = new ArrayList<FourTuple>();
        ...
        try {
            ...
            for (ParseObject l : list) {
                ...
                try {
                    ...
                    ids.add(new FourTuple((String) l.get("ProductID"), (String) l.get("Title")
                            , String.valueOf(l.get("Price")), bitmap));
        ...
        try {
            ...
            for (ParseObject l : list) {
                Bitmap bitmap;
                    ...
                    ids.add(new FourTuple((String) l.get("ProductID"), (String) l.get("Title")
                            , String.valueOf(l.get("Price")), null));
    ...
    public List<FourTuple> getCustomerCanceledSubscriptions(String username) {
        List<FourTuple> ids = new ArrayList<FourTuple>();
            /*Get all services and packages from parse database*/
        ParseQuery<ParseObject> query = ParseQuery.getQuery("CanceledSubscriptions");
    ...
    public List<FourTuple> getCustomerConcessions(String username) {
        List<FourTuple> ids = new ArrayList<FourTuple>();
            /*Get all services and packages from parse database*/
    ...
    public List<FourTuple> getCustomersSubscriptions(String username) {
        List<FourTuple> ids = new ArrayList<FourTuple>();
            /*Get all services and packages from parse database*/
    ...
    public boolean addPackage(String finalproductId, int typeOfProduct, double price) {
